...
public class Hotelgama {
	...
	private static void menuAdministrador() {
		...
		do {
			...
			switch (resAdmin) {
			case 0 -> JOptionPane.showMessageDialog(null, "Gestionar usuarios aún no implementado");
			case 1 -> JOptionPane.showMessageDialog(null, "Administrar futuras reservas aún no implementado");
			case 2 -> JOptionPane.showMessageDialog(null, "Ver reservas previas aún no implementado");
			}
